...
public class ChangePhotoLow extends JButton {

    int index = 0;
    public ChangePhotoLow(final int X_BUTTON_POSITION, final int Y_BUTTON_POSITION, final int WIDTH, final int HEIGHT)
    {
