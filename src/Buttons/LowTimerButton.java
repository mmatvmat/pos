...
public class LowTimerButton extends JButton {

    private static final String BUTTON_TEXT = "TIMER";

    public LowTimerButton(final int X_BUTTON_POSITION, final int Y_BUTTON_POSITION, final int WIDTH, final int HEIGHT)
    {
